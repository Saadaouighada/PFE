...
public class TiersListGridBlockService implements GridService
{
   public static final String  BEANID          = "TiersListGridBlockService";
   private static final Logger LOG             = Logger.getLogger(TiersListGridBlockService.class);
   public static final String  LIST_TIERS_NAME = "ListTiersGrid";
   @Override
            ...
            FunctionalContext functionalContext)
   {
      ...
      try
      {
         ...
         dataList = contextData.get(LIST_TIERS_NAME);
