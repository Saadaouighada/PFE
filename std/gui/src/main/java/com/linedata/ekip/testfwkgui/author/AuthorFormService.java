...
@Component
public class AuthorFormService implements FormService
{

   private static final String BEANID = "AuthorFormService";
   ...
   {
      AuthorData authorData = (AuthorData) screenContext.getEntity();
