...
@Component
public class TestBlockFormService implements FormService
{

   private static final String BEANID = "TestBlockFormService";
            ...
            FunctionalContext functionalContext)
   {
      ...
      outData.set("testField1", "aaa");
      outData.set("testField2", "bbb");
      outData.set("testField3", "ccc");
