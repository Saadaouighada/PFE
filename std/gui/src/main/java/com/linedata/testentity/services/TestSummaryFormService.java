...
@Component
public class TestSummaryFormService implements FormService
{

   private static final String BEANID = "TestSummaryFormService";
            ...
            FunctionalContext functionalContext)
   {
      ...
      summaryData.set("summaryField1", "summaryField1");
