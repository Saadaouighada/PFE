/*
 * Diff Match and Patch Copyright 2006 Google Inc.
 * http://code.google.com/p/google-diff-match-patch/ Licensed under the Apache
      ...
      while (thisDiff != null)
      {
         ...
         else
         {
            ...
            if (lastequality != null
                     && ((pre_ins && pre_del && post_ins && post_del) || ((lastequality.length() < Diff_EditCost / 2) && ((pre_ins ? 1 : 0) + (pre_del ? 1 : 0)
